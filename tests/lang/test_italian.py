...
IT_MORE_TEST_CASES = [
    ...
    ("Mi fissi un appuntamento per mar. 23 Nov.. Grazie.", ["Mi fissi un appuntamento per mar. 23 Nov..", "Grazie."]),
    (
    ...
    ('La "Mulino Bianco" fa alimentari pre-confezionati.', ['La "Mulino Bianco" fa alimentari pre-confezionati.']),
    (
    ...
    ("La maestra esclamò: \"Bambini, quanto fa '2/3 + 4/3?'\".", ["La maestra esclamò: \"Bambini, quanto fa '2/3 + 4/3?'\"."]),
