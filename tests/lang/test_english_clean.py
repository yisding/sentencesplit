...
TESTS_WITH_CLEAN = [
    ...
    ("Test strange period．Does it segment correctly．", ["Test strange period．", "Does it segment correctly．"]),
    (
...
TESTS_WO_CLEAN = [
    ...
    # set clean=False
    ("Some can be -- if I may say so? -- a bit questionable.", ["Some can be -- if I may say so? -- a bit questionable."]),
    # set clean=False
    (
