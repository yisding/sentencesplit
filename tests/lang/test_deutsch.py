...
GOLDEN_DE_RULES_TEST_CASES = [
    ...
    ("Was sind die Konsequenzen der Abstimmung vom 12. Juni?", ["Was sind die Konsequenzen der Abstimmung vom 12. Juni?"]),
]
...
DE_CLEAN_RULES_TEST_CASES = [
    ...
    ("Wir brauchen Getränke, z. B. Wasser, Saft, Bier usw.", ["Wir brauchen Getränke, z. B. Wasser, Saft, Bier usw."]),
    ...
    ("Er sagte: „Hallo, wie geht´s Ihnen, Frau Prof. Müller?“", ["Er sagte: „Hallo, wie geht´s Ihnen, Frau Prof. Müller?“"]),
    (
