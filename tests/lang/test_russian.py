...
RU_MORE_TEST_CASES = [
    ...
    ("Он сказал: «Я очень устал», и сразу же замолчал.", ["Он сказал: «Я очень устал», и сразу же замолчал."]),
    (
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("Ср. Иван пришел.", ["Ср.", "Иван пришел."]),
        ("Ср. В статье есть пример.", ["Ср.", "В статье есть пример."]),
        ("Он сравнил ср. Волгу и Днепр.", ["Он сравнил ср. Волгу и Днепр."]),
        ("Ср. Пушкина и Лермонтова.", ["Ср. Пушкина и Лермонтова."]),
        ("Это литература и др. «Она важна».", ["Это литература и др.", "«Она важна»."]),
