...
ES_MORE_TEST_CASES = [
    ...
    ("La habitación tiene 20.55m². El living tiene 50.0m².", ["La habitación tiene 20.55m².", "El living tiene 50.0m²."]),
    ("1°C corresponde a 33.8°F. ¿A cuánto corresponde 35°C?", ["1°C corresponde a 33.8°F.", "¿A cuánto corresponde 35°C?"]),
    (
    ...
    ("1 + 1 es 2. 2 + 2 es 4. El auto es de color rojo.", ["1 + 1 es 2.", "2 + 2 es 4.", "El auto es de color rojo."]),
    (
