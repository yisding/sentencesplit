...
tests = [
    (
        "April 14 merge",
        "Lincoln attended the play on the evening of April 14. At the last minute, Grant decided to go.",
    ),
    (
        "version 2 merge",
...
p = Processor(
    "This is version 2. The new version is better.", EnglishLang, char_span=False
)
