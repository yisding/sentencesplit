...
from sentencesplit.lang.common.abbreviations import canonical_abbreviations
...
class Standard:
    ...
    class Abbreviation:
        ...
        # ``canonical_abbreviations`` and the ``test_abbreviations_are_canonical_form``
        # lint. The wrapper guarantees the property at class-definition time so the
        # human-edited source list need not be kept hand-sorted.
