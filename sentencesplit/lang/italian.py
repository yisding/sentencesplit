...
class Italian(Common, Standard):
    ...
    # inherited from Standard directly. It is NOT one of the
    # CAPITALIZED_FOLLOWER_IS_BOUNDARY_CUE languages (Italian capitalizes proper
    # nouns mid-sentence), so that flag stays off and capital followers flow
